...
def popularDishes(EntryUserId):
    window = Tk()
    window.title('popularDishes')
    ...
    popularDishesList = getPopularDishes()
    rowCount = 4
    ...
    for i  in range(10):
        price_label = Label(window, text=popularDishesList[i], font=font_header, justify=CENTER, **header_padding, foreground='dark blue', background="light pink")
